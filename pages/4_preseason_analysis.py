...
st.markdown("# Pre-season Practice Analysis")
st.write("## :chart_with_upwards_trend: Plot lots of things! :chart_with_downwards_trend:")
st.write("This page is to analyse pre-season sessions.")
st.write("If it appears that a rider has only done a few laps, check the maximum lap time cut off. "
         "Any laps slower than this are removed, so increase it to see more data.")
